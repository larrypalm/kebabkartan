          ...
          <Card padding="lg">
            ...
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold text-slate-900 mb-2">
                Gå med i Kebabkartan
              </h1>
              <p className="text-slate-600">
                Hjälp oss hitta Sveriges bästa sås
              </p>
            </div>
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white text-slate-500">Eller registrera med</span>
              </div>
            </div>
            ...
            <Button
              ...
              onClick={() => {
                ...
                console.log('Google SSO not yet implemented');
              }}
            >
